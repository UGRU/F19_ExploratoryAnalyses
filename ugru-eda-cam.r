...
#pretending iris is a file I read in.
#if not using readr, ALWAYS add the stringsAsFactors = FALSE argument.
...
#functions to get size related numbers, so you don't have to hard code them
...
#i.e. this is robust to changes to the dataframe size
...
#subset one columns using another's values
...
#some string maniplulation examples building on jackie's stuff
